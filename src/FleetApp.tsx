    ...
    return (
      <div className="min-h-screen bg-[#050505] text-white p-6 pb-32">
        ...
        <header className="flex items-center justify-between mb-8 pt-4">
          <div>
            <h1 className="text-3xl font-black">Fleet <span className="text-primary">Dashboard</span></h1>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white/5 backdrop-blur-md p-6 rounded-[28px] border border-white/10">
            <span className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold block mb-1">Assigned</span>
            <span className="text-2xl font-black">{activeOrders.length}</span>
          </div>
          <div className="bg-white/5 backdrop-blur-md p-6 rounded-[28px] border border-white/10">
            <span className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold block mb-1">Today</span>
        ...
        <div className="fixed bottom-8 left-6 right-6 h-20 bg-black/80 backdrop-blur-xl border border-white/10 rounded-[28px] flex items-center justify-around px-8 z-50">
          <button className="text-primary"><Box className="w-6 h-6" /></button>
          <button className="text-on-surface-variant/40"><Car className="w-6 h-6" /></button>
          <button className="text-on-surface-variant/40"><Clock className="w-6 h-6" /></button>
          <button className="text-on-surface-variant/40"><Settings className="w-6 h-6" /></button>
        </div>
      </div>
    );
  }
