...
export const products: Product[] = [
  ...
  // ── Bulk Value Packs — Walmart / Sam's / Costco ──────────────────────
  {
    id: '71',
    name: 'Goldfish Crackers Cheddar (27 oz)',
    description: 'Massively shareable bag of the tiny crunchy classic. Grab and go energy.',
    price: 8.99,
    tag: 'Popular',
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '72',
    name: 'Combos Cheese & Pretzel (13.7 oz)',
    description: 'Soft cheesy pretzel insides wrapped in a crunch. Dangerously addictive combo.',
    price: 7.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '73',
    name: 'Pepsi 12-Pack (12 oz Cans)',
    description: 'A dozen cans of bold, refreshing cola. The Pepsi choice in bulk.',
    price: 9.99,
    tag: 'Popular',
    image: '',
    categoryId: 'drinks',
  ...
  {
    id: '74',
    name: 'Fanta Variety Pack (12-Pack)',
    description: 'Six flavors of vibrant fruity fanta — orange, grape, strawberry, and more.',
    price: 10.99,
    tag: 'Popular',
    image: '',
    categoryId: 'drinks',
  ...
  {
    id: '75',
    name: 'Tropicana Orange Juice (59 oz)',
    description: 'Large carton of pure OJ — fresh-squeezed taste in a gallon-plus volume.',
    price: 5.49,
    tag: 'Fresh',
    image: '',
    categoryId: 'drinks',
  ...
  {
    id: '76',
    name: 'Funyuns Original (6 oz)',
    description: 'Onion rings in snack form — crispy, light, dangerously vanishing fast.',
    price: 1.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '77',
    name: 'Corn Nuts Original (4 oz)',
    description: 'Roasted kernel crunchers with serious bite. The road-trip fuel of choice.',
    price: 1.49,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '78',
    name: 'Slim Jim Original Beef Sticks (20 Count)',
    description: 'Two-decades-deep snack pack. Salty, smoky, protein-rich sticks.',
    price: 12.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '79',
    name: 'Jack Link\'s Teriyaki Beef Jerky (3.25 oz)',
    description: 'Sweet teriyaki glaze on real lean beef. Chew-it-up jerky done right.',
    price: 5.99,
    tag: 'Popular',
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '80',
    name: 'Twinkies Family Pack (10-Pack)',
    description: 'Ten golden sponge cakes filled with creamy filling. Nostalgia incarnate.',
    price: 6.99,
    tag: 'Popular',
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '81',
    name: 'Little Debbie Oatmeal Crème Pies (10-Pack)',
    description: 'Soft oatmeal cookies sandwiched with gooey creme filling. Ten snack wins.',
    price: 6.49,
    tag: null,
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '82',
    name: 'Hostess Cupcakes Chocolate (10-Pack)',
    description: 'Chocolate cake cups with creamy centers and white frosting swirl. Party-ready.',
    price: 7.49,
    tag: 'Popular',
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '83',
    name: 'Sunflower Seeds (5 oz)',
    description: 'Salted roasted sunflower seeds — the original endless snack of focus.',
    price: 3.49,
    tag: 'Fresh',
    image: '',
    categoryId: 'organic',
  ...
  {
    id: '84',
    name: 'Fritos Original Corn Chips (9.25 oz)',
    description: 'Pure corn fried into iconic crunchy triangles. Zero B.S., pure salt and corn.',
    price: 5.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '85',
    name: 'Cheetos Puffs (8 oz)',
    description: 'Light airy puffed corn dusted in cheese powder. The cloud-like snack experience.',
    price: 5.49,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '86',
    name: 'Doritos Flamin\' Hot Nacho (10.5 oz)',
    description: 'Nacho meets serious heat. Spicy dusted triangles that pack a real punch.',
    price: 6.99,
    tag: 'Popular',
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '87',
    name: 'Cup Noodles Chicken (2.25 oz)',
    description: 'Three-minute soup in a styrofoam cup. The college dorm classic done right.',
    price: 0.79,
    tag: null,
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '88',
    name: 'Maruchan Instant Ramen Beef (3 oz)',
    description: 'Budget-friendly bulk noodles with a beefy packet. Boil, slurp, gone.',
    price: 0.29,
    tag: null,
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '89',
    name: 'Pork Rinds BBQ Flavored (2.5 oz)',
    description: 'Crispy fried pork belly with smoky BBQ dust. Keto-friendly crunch.',
    price: 3.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '90',
    name: 'Trail Mix Classic (15 oz)',
    description: 'Nuts, dried fruit, and chocolate chips — the hiker\'s favorite energy bomb.',
    price: 9.99,
    tag: 'Fresh',
    image: '',
    categoryId: 'organic',
  ...
  {
    id: '91',
    name: 'Baked Lay\'s Original (10 oz)',
    description: 'The lighter crispy chip choice — same flavor, less guilt, same addictive crunch.',
    price: 5.99,
    tag: 'Fresh',
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '92',
    name: 'Cheez Whiz Spread (8 oz Jar)',
    description: 'Smooth cheese spread ready to dip, spread, or melt. Cheese in paste form.',
    price: 3.99,
    tag: null,
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '93',
    name: 'Nutty Bars (12-Pack)',
    description: 'Little Debbie wafer cookies with peanut frosting and chocolate coating.',
    price: 5.99,
    tag: null,
    image: '',
    categoryId: 'latenightfix',
  ...
  {
    id: '94',
    name: 'Gushers Tropical Punch (10-Pack)',
    description: 'Fruity gummy pockets that burst in your mouth. Texture twist meets flavor.',
    price: 4.99,
    tag: 'Popular',
    image: '',
    categoryId: 'snacks',
  ...
  {
    id: '95',
    name: 'Sprite Zero Sugar 12-Pack (12 oz Cans)',
    description: 'All crisp lemon-lime flavor, zero calories. The guilt-free citrus choice.',
    price: 9.99,
    tag: 'Fresh',
    image: '',
    categoryId: 'drinks',
